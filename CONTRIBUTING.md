...
### ✅ **已完成 (PR #2)** — B2. MobilitySpace 地图（M3 从代理升真算）— 难度高·依赖重
...
### ✅ **已完成 (PR #2)** — B3. RelationshipSpace（M7 从代理升真算）— 中等
...
### ✅ **已完成 (PR #2)** — B4. Billboard/Blog 公开表达（M6 从代理升真算）— 中等
...
### ✅ **已完成 (PR #2)** — B5. 完整 pydantic scenario DSL — 低难度
...
### ✅ **已完成 (PR #2)** — B6. Concordia 后端适配器 — 中等·兑现"后端可换"claim
